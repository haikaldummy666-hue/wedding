...
export const WeddingGift = () => {
  ...
  return (
    <section id="gift" ref={ref} className="py-16 md:py-24 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-8">
          ...
          {weddingConfig.bankAccounts.map((account, index) => (
            ...
            >
              <Card className="glass-card border-rose-gold-light/30 overflow-hidden h-full">
                <CardContent className="p-6 text-center">
                  ...
                  <Button
                    variant="outline"
                    className="rounded-full border-rose-gold-light hover:bg-rose-gold-light/10"
